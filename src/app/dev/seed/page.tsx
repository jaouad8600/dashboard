...
export default function SeedPage() {
  ...
  function clearAll() {
    ["overdracht-history-v1", "sportmutaties-v1", "indicaties-v1"].forEach(
  ...
  return (
    ...
    >
      ...
      <p>
        Met de knoppen hieronder zet je voorbeelddata in{" "}
      ...
      <p style={{ marginTop: 24 }}>
        Tip: ga daarna naar <a href="/admin">/admin</a> om de widgets te zien.
      </p>
    </div>
  );
}
