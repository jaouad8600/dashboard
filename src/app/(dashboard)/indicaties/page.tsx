                    ...
                    className={
                      r.status === "open"
                        ...
                        : r.status === "in-behandeling"
                          ? "text-indigo-700 bg-indigo-100 px-2 py-0.5 rounded"
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow max-w-xl w-full p-4 space-y-3">
            <div className="text-lg font-semibold">
              {sel.id ? "Indicatie bewerken" : "Nieuwe indicatie"}
            </div>
            <div className="grid md:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  value={sel.naam || ""}
                  onChange={(e) => setSel({ ...sel, naam: e.target.value })}
                  className="border rounded px-2 py-1 w-full"
                />
              </div>
              <div>
                ...
                <input
                  value={sel.type || ""}
                  onChange={(e) => setSel({ ...sel, type: e.target.value })}
                  className="border rounded px-2 py-1 w-full"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  type="date"
                  value={(sel.start || "").slice(0, 10)}
                  onChange={(e) => setSel({ ...sel, start: e.target.value })}
                  className="border rounded px-2 py-1 w-full"
                />
              </div>
              <div>
                ...
                <input
                  type="date"
                  value={(sel.eind || "").slice(0, 10)}
                  onChange={(e) => setSel({ ...sel, eind: e.target.value })}
                  className="border rounded px-2 py-1 w-full"
                />
              </div>
              <div className="md:col-span-2">
                ...
                <textarea
                  value={sel.opmerking || ""}
                  onChange={(e) =>
                    setSel({ ...sel, opmerking: e.target.value })
                  }
                  className="border rounded px-2 py-1 w-full"
                  rows={3}
                />
