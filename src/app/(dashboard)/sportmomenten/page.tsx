  ...
  return (
    <div className="p-6">
      <div className="flex gap-2 mb-4">
        <button className="btn btn-primary bg-emerald-600 text-white px-3 py-2 rounded" onClick={()=>setAnchor(new Date())}>Vandaag</button>
        <button className="btn btn-primary bg-emerald-600 text-white px-3 py-2 rounded" onClick={()=>setAnchor(addDays(weekStart,-7))}>← Vorige</button>
        <button className="btn btn-primary bg-emerald-600 text-white px-3 py-2 rounded" onClick={()=>setAnchor(addDays(weekStart, 7))}>Volgende →</button>
