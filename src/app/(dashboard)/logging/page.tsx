    ...
    <div className="grid gap-3">
      ...
      <div className="grid gap-2 p-3 rounded-2xl border bg-white">
        ...
        <div className="flex gap-2">
          <button onClick={add} className="px-3 py-2 rounded-xl border">Opslaan</button>
          <button onClick={()=>dl("logging.csv",csv,"text/csv")} className="px-3 py-2 rounded-xl border">Exporteer CSV</button>
        </div>
      </div>
