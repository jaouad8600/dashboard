...
Bijzonderheden: gevoetbald tegen de Duin, goede sfeer.`;
    ...
    alert(
      "Overdracht-ruw seeded. Ga naar Overdrachten en klik Parse + Opslaan.",
    );
  }
  return (
    <div className="p-4 grid gap-3">
      <h1 className="text-xl font-bold">Debug / Seed</h1>
      <button onClick={seedEvents} className="btn btn-primary px-3 py-2 rounded-xl border btn">
        Seed demo events
      </button>
      <button
      ...
      <p className="text-sm opacity-70">
        Daarna: /overdrachten → Parse + Opslaan → /admin
      </p>
    </div>
  );
}
