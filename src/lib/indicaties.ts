...
let _rows: Indicatie[] = [
  // Voorbeeld uit jouw formulier (beknopt), zodat je meteen data ziet:
  {
    ...
    van: "2025-09-15",
    tot: "2025-10-15",
    tips: "Langzaam praten, herhalen, consequent & duidelijk; niet autoritair benaderen; controleer begrip.",
    leerdoelen:
...
export function addIndicatie(
  i: Omit<Indicatie, "id" | "createdAt">,
): Indicatie {
  const row: Indicatie = {
    ...i,
    id: crypto.randomUUID(),
...
export function updateIndicatie(
  id: string,
