...
import { Home, CalendarDays, ClipboardList, Users, FileText, PackageSearch, Settings } from "lucide-react";
      ...
      <nav className="flex-1 px-2 pb-3 space-y-1 overflow-auto">
        {NAV.map(item=>{
          ...
          return (
            ...
            >
              <Icon size={18} className={clsx(active ? "text-brand-700":"text-zinc-500")} />
